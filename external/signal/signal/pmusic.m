...
%         If NFFT is even, S will have length NFFT/2+1 and will be
%         computed over the interval [0,Pi].  If NFFT is odd, the length
%         of S becomes (NFFT+1)/2 and the interval becomes [0,Pi).
...
%         input X.  In this case, S will have length NFFT and will be
...
%         complex input X.  In this case, S will have length NFFT and will
...
% center dc if needed
if md.centerdc
   [Sxx, w] = signal.internal.spectral.psdcenterdc(Sxx, w, [], md);
end
