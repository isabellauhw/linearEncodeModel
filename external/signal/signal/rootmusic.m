...
roots_D = roots(D);
% Because D is formed from the product of a polynomial and its conjugated
% and reversed version, every root of D inside the unit circle, will have a
% "reflected" version outside the unit circle. We choose to use the ones
% inside the unit circle, because the distance from them to the unit circle
% will be smaller than the corresponding distance for the "reflected" root.
