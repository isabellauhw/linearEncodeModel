...
elseif isprop(d,'SystemObject') && d.SystemObject
    % Suppress MFILT deprecation warning if System object has been
    % requested and the structure is supported.
    w = warning('off', 'signal:fdesign:basecatalog:UseSystemObjectForMultirateDesigns');
