classdef bspassfstop < fspecs.bspass
%BSPASSFSTOP   Construct an BSPASSFSTOP object.

%   Copyright 1999-2015 The MathWorks, Inc.

%fspecs.bspassfstop class
%   fspecs.bspassfstop extends fspecs.bspass.
%
%    fspecs.bspassfstop properties:
