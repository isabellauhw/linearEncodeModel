classdef gaussian < fdesign.abstractpulseshape
...
%fdesign.gaussian class
%   fdesign.gaussian extends fdesign.abstractpulseshape.
%
%    fdesign.gaussian properties:
...
%       Specification - Property is of type 'GaussianSpecTypeswFDTbx enumeration: {'Nsym,BT'}'  
%
%    fdesign.gaussian methods:
...
methods  % constructor block
  function this = gaussian(varargin)
    ...
    this.Response = 'Gaussian';
    
    this.Specification = 'Nsym,BT';
