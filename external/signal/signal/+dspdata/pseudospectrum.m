classdef pseudospectrum < dspdata.abstractfreqrespwspectrumrangeMCOS
  %dspdata.pseudospectrum class
  %   dspdata.pseudospectrum extends dspdata.abstractfreqrespwspectrumrange.
  %
  %    dspdata.pseudospectrum properties:
  ...
  %
  %    dspdata.pseudospectrum methods:
  %       getname -   Get the name to be used in plot title.
  ...
  methods  %% public methods
    ...
    function ylabel = getylabel(this)
      ...
      ylabel = getString(message('signal:dspdata:dspdata:PseudospectrumdB'));
