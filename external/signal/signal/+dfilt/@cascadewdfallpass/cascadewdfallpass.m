classdef (CaseInsensitiveProperties=true,TruncatedProperties = true) cascadewdfallpass < dfilt.abstractcascadeallpass
    ...
    %dfilt.cascadewdfallpass class
    %   dfilt.cascadewdfallpass extends dfilt.abstractcascadeallpass.
    %
    %    dfilt.cascadewdfallpass properties:
    ...
    %
    %    dfilt.cascadewdfallpass methods:
