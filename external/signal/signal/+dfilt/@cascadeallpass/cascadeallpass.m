classdef (CaseInsensitiveProperties=true,TruncatedProperties = true) cascadeallpass < dfilt.abstractcascadeallpass
    ...
    %dfilt.cascadeallpass class
    %   dfilt.cascadeallpass extends dfilt.abstractcascadeallpass.
    %
    %    dfilt.cascadeallpass properties:
