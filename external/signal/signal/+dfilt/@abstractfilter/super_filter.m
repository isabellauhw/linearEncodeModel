...
if isa(x,'gpuArray')
    error(message('signal:dfilt:abstractfilter:super_filter:GPUInput'));
end
...
% Need to suppress code analyzer warning here. We must output the sizes
% as scalars for certain filter designs.
[Mxi,Nxi] = size(xi); %#ok<ASGLU>
