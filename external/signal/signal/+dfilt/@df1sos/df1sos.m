classdef (CaseInsensitiveProperties=true,TruncatedProperties = true) df1sos < dfilt.abstractsos
    ...
    %dfilt.df1sos class
    %   dfilt.df1sos extends dfilt.abstractsos.
    %
    %    dfilt.df1sos properties:
