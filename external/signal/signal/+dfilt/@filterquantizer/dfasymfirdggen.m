function DGDF = dfasymfirdggen(q,Hd,coeffnames,doMapCoeffsToPorts,states)
...
DGDF = gen_DG_dfasymfir_stages(q,num,Hd,info);
...
%
% -------------------------------------------------------------------------
function DGDF = gen_DG_dfasymfir_stages(q,num,H,info,hTar)
...
elseif max_order > 1
    ...
    Stg = dfasymfirheader_order0(q,num,H,info);
end
...
DGDF = filtgraph.dg_dfilt(Stg,'dfasym');
