classdef (CaseInsensitiveProperties=true,TruncatedProperties = true) dfasymfir < dfilt.abstractdfsymfir
    ...
    %dfilt.dfasymfir class
    %   dfilt.dfasymfir extends dfilt.abstractdfsymfir.
    %
    %    dfilt.dfasymfir properties:
