classdef (CaseInsensitiveProperties=true,TruncatedProperties = true) df1t < dfilt.dtfiir
    ...
    %dfilt.df1t class
    %   dfilt.df1t extends dfilt.dtfiir.
    %
    %    dfilt.df1t properties:
    ...
    %       Denominator - Property is of type 'mxArray'  1
