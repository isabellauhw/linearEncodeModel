...
coder.internal.errorIf(cond,'signal:welch:CodegenNotEnoughOutputs');
...
for i = 1:nargout
    varargout{i} = real(welchOut{i});
end
end

% [EOF]

% LocalWords:  Welch's Pxx periodograms sidelobe tradeoffs SPECTRUMTYPE
% LocalWords:  NOVERLAP NFFT Fs Pxxc FREQRANGE maxhold minhold Petre Stoica
% LocalWords:  Monson
