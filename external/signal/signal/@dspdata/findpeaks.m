function [pks,frqs] =findpeaks(this,varargin) %#ok<STOUT,INUSD>
%FINDPEAKS Find local peaks in data
%
%   DSPDATA.FINDPEAKS is not recommended.  Use <a href="matlab:help findpeaks">findpeaks</a> instead
%
...
%
%   [...] = FINDPEAKS(H,'NPEAKS',NP) specifies the number of peaks to be
