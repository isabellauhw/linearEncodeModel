...
if isempty(h) || issparse(h) || ~isa(h,'double') || ~all(isfinite(h),'all')
...
% LocalWords:  Upsampling th Lx Lh Nx Nh downconvert Lp Fs resampled columnize
% LocalWords:  Sizemismatch PNQ
