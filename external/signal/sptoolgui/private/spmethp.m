...
% BURG METHOD
%ADDCATALOG The whole file needs to be revised for translating the help
m = [];
m(1).methodName = getString(message('signal:sptoolgui:Burg'));
m(1).methodHelp = {
'Burg Method'
' '
...
% Covariance AR
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:Covariance'));
m(end).methodHelp = {
'Covariance AR'
' '
...
% FFT 
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:FFT'));
m(end).methodHelp = {
   'FFT Method'
   ' '
...
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:ModCovar'));
m(end).methodHelp = {
'Modified Covariance AR'
' '
...
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:MTM'));
m(end).methodHelp = {
...
%  MUSIC METHOD
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:MUSIC'));
m(end).methodHelp = {
...
%  WELCH'S METHOD
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:Welch'));
m(end).methodHelp = {
...
% Yule-Walker AR
m(end+1) = m(1);
m(end).methodName = getString(message('signal:sptoolgui:YuleAR'));
m(end).methodHelp = {
'Yule-Walker AR'
' '
