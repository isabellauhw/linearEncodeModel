...
case 'popup'
    ...
    [val,ok] = listdlg('Name',getString(message('signal:sptoolgui:SelectATrace')),...
    ...
    set(ud.toolbar.select,'TooltipString',...
           sprintf('%s',getString(message('signal:sptoolgui:SelectTraceCurrentlySelected',legendList{val}))))
...
case 'setvalue'
    ...
    if ~isempty(legendList) & ~isempty(i)
        ...
        set(ud.toolbar.select,'TooltipString',...
           sprintf('%s',getString(message('signal:sptoolgui:SelectTraceCurrentlySelected',legendList{ind}))))
        
    else
        set(ud.toolbar.select,'Enable','off')
        set(ud.toolbar.lineprop,'Enable','off')
        set(ud.toolbar.select,'TooltipString',...
           getString(message('signal:sptoolgui:SelectTraceCurrentlySelectednone')))
    end
...
case 'setstring'
   ...
   if isempty(legendStr)
      ...
      set(ud.toolbar.lineprop,'Enable','on')
      set(ud.toolbar.select,'TooltipString',...
           sprintf('%s',getString(message('signal:sptoolgui:SelectTraceCurrentlySelected',legendStr{val}))),...
           'UserData',ud_s)
   end
   if retainValueFlag
