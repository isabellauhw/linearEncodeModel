...
if strncmp(tag,'WT?',3)
    ...
    msg = getString(message('signal:sigtools:cshelpengine:ContextsensitiveHelpTag'));
...
hmsg = errordlg(msg,[toolname ' ' getString(message('signal:sigtools:cshelpengine:HelpError'))],'modal');
