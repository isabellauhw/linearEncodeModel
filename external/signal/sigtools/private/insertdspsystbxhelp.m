function h = insertdspsystbxhelp(hFDA,indx)
%INSERTDSPSYSTBXHELP Insert DSP System Toolbox help
%   INSERTDSPSYSTBXHELP(HFDA, INDX) creates three help menu items under
...
h(1) = addmenu(hFDA,[pos indx(1)],getString(message('signal:sigtools:private:DSPSystemToolboxHelp')),@fdproducthelp_cb,'fdhelp');
h(2) = addmenu(hFDA,[pos indx(2)],getString(message('signal:sigtools:private:DSPSystemToolboxDemos')),@fddemos_cb,'fddemos');
h(3) = addmenu(hFDA,[pos indx(3)],getString(message('signal:sigtools:private:AboutDSPSystemToolbox')),@fdabout_cb,'fdabout');
