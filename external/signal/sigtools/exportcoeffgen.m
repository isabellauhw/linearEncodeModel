...
if isempty(itype)
    error(message('signal:exportcoeffgen:NotSupported', e.DataType));
end
...
if n == length(a)
    ...
    return;
elseif n < length(a)
    error(message('signal:exportcoeffgen:GUIErr'));
end
if ~isnumeric(a)
    error(message('signal:exportcoeffgen:MustBeNumeric'));
end
classname = class(a);
[r,c] = size(a);
if r > 1
