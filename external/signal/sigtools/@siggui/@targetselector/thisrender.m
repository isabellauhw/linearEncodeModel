...
hPanel = uipanel('Parent', hFig, ...
    'Units', 'Pixels', ...
    'Position', pos, ...
    'Title', getString(message('signal:sigtools:siggui:TargetSelection')), ...
    'Visible', 'Off');

set(this, 'Parent', hFig, 'Container', hPanel);

rendercontrols(this, hPanel);
renderactionbtn(this, pos, getString(message('signal:sigtools:siggui:SelectTarget')), 'selecttarget');
