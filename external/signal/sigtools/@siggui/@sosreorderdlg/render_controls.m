...
% allow text to exceed halfway point
ext = get(h.pnorm_lbl(1),'Extent');
set(h.pnorm_lbl(1),'Position',[pos(1:2) ext(3) pos(4)]);
...
% allow text to exceed halfway point
ext = get(h.pnorm_lbl(2),'Extent');
set(h.pnorm_lbl(2),'Position',[pos(1)+pos(3)-ext(3) pos(2) ext(3) pos(4)]);
