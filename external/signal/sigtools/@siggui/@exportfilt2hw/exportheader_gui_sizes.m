...
% "458+30" - 30 added to fit in signal:sigtools:siggui:DisableMemoryTransferWarnings
sz.variableframe = [x sz.datatype(2)+sz.datatype(4) + sz.vffs/2 [458+30 130]*sz.pixf];
