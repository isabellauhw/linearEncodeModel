...
str = getString(message('signal:sigtools:siggui:DoNotShowMeThisAgain'));
...
buttonw   = largestuiwidth({getString(message('signal:sigtools:siggui:Close'))})+4*sz.hfus;
...
if this.NoHelpButton
    ...
    h.help  = uicontrol(hFig, ...
        'Style', 'PushButton', ...
        'String', getString(message('signal:sigtools:siggui:Help')), ...
        'Position', buttonpos, ...
...
h.close = uicontrol(hFig, ...
    'Style', 'PushButton', ...
    'String', getString(message('signal:sigtools:siggui:Close')), ...
    'Position', closepos, ...
