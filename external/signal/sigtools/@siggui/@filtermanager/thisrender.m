...
hFig = figure('Position', [200 200 400 300]*sz.pixf, ...
    ...
    'NumberTitle', 'Off', ...
    'Tag', 'FilterManager', ...
    'Name', getString(message('signal:sigtools:siggui:FilterManager')), ...
    'IntegerHandle', 'Off', ...
    'MenuBar', 'none', ...
...
h.cascade = uicontrol(h.toppanel, ...
    'Tag', 'Cascade', ...
    'Style', 'Pushbutton', ...
    'String', getString(message('signal:sigtools:siggui:Cascade')), ...
    'Callback', {cbs.method, this, 'cascade'});

% Render the cascade button
h.rename = uicontrol(h.toppanel, ...
    'Style', 'Pushbutton', ...
    'String', getString(message('signal:sigtools:siggui:Rename')), ...
...
h.delete = uicontrol(h.toppanel, ...
    'Tag', 'Delete', ...                     
    'Style', 'Pushbutton', ...
    'String', getString(message('signal:sigtools:siggui:Remove')), ...
...
h.overwrite = uicontrol(h.toppanel, ...
    'Tag', 'Overwrite', ...
    'Style', 'Check', ...
    'String', getString(message('signal:sigtools:siggui:EditCurrentFilter')), ...
...
h.currentfilter = uicontrol(hFig, ...
    ...
    'String', sprintf('%s: ', getString(message('signal:sigtools:siggui:CurrentFilter'))));
...
names = getnames(this);
if isempty(names)
    names = {getString(message('signal:sigtools:siggui:ThereAreNoStoredFilters'))};
end
...
set(h.currentfilter, 'String', sprintf('%s: %s', getString(message('signal:sigtools:siggui:CurrentFilter')), names{1}));
