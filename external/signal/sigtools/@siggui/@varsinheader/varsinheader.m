...
lbls.tf          = {getString(message('signal:sigtools:siggui:Numerator')), getString(message('signal:sigtools:siggui:Denominator'))};
lbls.fir         = {getString(message('signal:sigtools:siggui:Numerator')), ''};
lbls.statespace  = {getString(message('signal:sigtools:siggui:SSCoeffs')), ''};
lbls.lattice     = {getString(message('signal:sigtools:siggui:Latticecoeff')), ''};
lbls.latticearma = {getString(message('signal:sigtools:siggui:Latticecoeff')), getString(message('signal:sigtools:siggui:Laddercoeff'))};
