...
strs = {getString(message('signal:sigtools:render_sptfilemenu:File')), ...
        getString(message('signal:sigtools:render_sptfilemenu:Export')), ...
        getString(message('signal:sigtools:render_sptfilemenu:Preferences')), ...
        getString(message('signal:sigtools:render_sptfilemenu:PrintSetup')), ...
        getString(message('signal:sigtools:render_sptfilemenu:PrintPreview')), ...
        getString(message('signal:sigtools:render_sptfilemenu:Print')), ...
        getString(message('signal:sigtools:render_sptfilemenu:Close'))};
...
% -------------------------------------------------------------------------
function localSaveExport(hcbo, eventData, hfig) %#ok
...
while isempty(newfile)
    [newfile, newpath, typevalue] = uiputfile(filter, getString(message('signal:sigtools:render_sptfilemenu:SaveAs')),filename);
end
...
try
  ...
  uiwait(errordlg(ME.message,getString(message('signal:sigtools:render_sptfilemenu:ErrorSavingFigure')),'modal'));
end
