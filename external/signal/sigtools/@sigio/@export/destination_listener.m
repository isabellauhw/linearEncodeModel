...
wrl(end-2) = handle.listener(hnewd, 'NewFrameHeight', @newheight_cb);
wrl(end-1) = handle.listener(hnewd, 'UserModifiedSpecs', @usermodifiedspecs_cb);
wrl(end)   = handle.listener(hnewd, 'ForceResize', @(~,~) resize(this));
