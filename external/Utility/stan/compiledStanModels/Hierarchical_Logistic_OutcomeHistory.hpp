...
namespace Hierarchical_Logistic_OutcomeHistory_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "//qnap-al001.dpag.ox.ac.uk/code/Analysis/Utility/stan/compiledStanModels/Hierarchical_Logistic_OutcomeHistory.stan");
    reader.add_event(108, 106, "end", "//qnap-al001.dpag.ox.ac.uk/code/Analysis/Utility/stan/compiledStanModels/Hierarchical_Logistic_OutcomeHistory.stan");
    return reader;
}

class Hierarchical_Logistic_OutcomeHistory_model : public prob_grad {
private:
        int numTrials;
        int numSessions;
        int numSubjects;
        ...
        std::vector<int> prevWin;
        std::vector<int> prevLose;
public:
    Hierarchical_Logistic_OutcomeHistory_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "Hierarchical_Logistic_OutcomeHistory_model_namespace::Hierarchical_Logistic_OutcomeHistory_model";
        ...
        try {
            ...
            validate_non_negative_index("prevWin", "numTrials", numTrials);
            context__.validate_dims("data initialization", "prevWin", "int", context__.to_vec(numTrials));
            prevWin = std::vector<int>(numTrials, int(0));
            vals_i__ = context__.vals_i("prevWin");
            pos__ = 0;
            size_t prevWin_k_0_max__ = numTrials;
            for (size_t k_0__ = 0; k_0__ < prevWin_k_0_max__; ++k_0__) {
                prevWin[k_0__] = vals_i__[pos__++];
            }
            size_t prevWin_i_0_max__ = numTrials;
            for (size_t i_0__ = 0; i_0__ < prevWin_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "prevWin[i_0__]", prevWin[i_0__], -(1));
                check_less_or_equal(function__, "prevWin[i_0__]", prevWin[i_0__], 1);
            }

            current_statement_begin__ = 15;
            validate_non_negative_index("prevLose", "numTrials", numTrials);
            context__.validate_dims("data initialization", "prevLose", "int", context__.to_vec(numTrials));
            prevLose = std::vector<int>(numTrials, int(0));
            vals_i__ = context__.vals_i("prevLose");
            pos__ = 0;
            size_t prevLose_k_0_max__ = numTrials;
            for (size_t k_0__ = 0; k_0__ < prevLose_k_0_max__; ++k_0__) {
                prevLose[k_0__] = vals_i__[pos__++];
            }
            size_t prevLose_i_0_max__ = numTrials;
            for (size_t i_0__ = 0; i_0__ < prevLose_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "prevLose[i_0__]", prevLose[i_0__], -(1));
                check_less_or_equal(function__, "prevLose[i_0__]", prevLose[i_0__], 1);
            }
    ...
    ~Hierarchical_Logistic_OutcomeHistory_model() { }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 23;
        if (!(context__.contains_r("prevWinEffect")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable prevWinEffect missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("prevWinEffect");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "prevWinEffect", "double", context__.to_vec());
        double prevWinEffect(0);
        prevWinEffect = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(prevWinEffect);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable prevWinEffect: ") + e.what()), current_statement_begin__, prog_reader__());
        }

        current_statement_begin__ = 24;
        if (!(context__.contains_r("prevLoseEffect")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable prevLoseEffect missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("prevLoseEffect");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "prevLoseEffect", "double", context__.to_vec());
        double prevLoseEffect(0);
        prevLoseEffect = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(prevLoseEffect);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable prevLoseEffect: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        ...
        pos__ = 0U;
        validate_non_negative_index("sd_sess", "5", 5);
        context__.validate_dims("parameter initialization", "sd_sess", "vector_d", context__.to_vec(5));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sd_sess(5);
        size_t sd_sess_j_1_max__ = 5;
        ...
        validate_non_negative_index("z_sess", "5", 5);
        validate_non_negative_index("z_sess", "numSessions", numSessions);
        context__.validate_dims("parameter initialization", "z_sess", "matrix_d", context__.to_vec(5,numSessions));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> z_sess(5, numSessions);
        size_t z_sess_j_2_max__ = numSessions;
        size_t z_sess_j_1_max__ = 5;
        ...
        validate_non_negative_index("rho_sess", "5", 5);
        validate_non_negative_index("rho_sess", "5", 5);
        context__.validate_dims("parameter initialization", "rho_sess", "matrix_d", context__.to_vec(5,5));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> rho_sess(5, 5);
        size_t rho_sess_j_2_max__ = 5;
        size_t rho_sess_j_1_max__ = 5;
        ...
        pos__ = 0U;
        validate_non_negative_index("sd_subj", "5", 5);
        context__.validate_dims("parameter initialization", "sd_subj", "vector_d", context__.to_vec(5));
        Eigen::Matrix<double, Eigen::Dynamic, 1> sd_subj(5);
        size_t sd_subj_j_1_max__ = 5;
        ...
        validate_non_negative_index("z_subj", "5", 5);
        validate_non_negative_index("z_subj", "numSubjects", numSubjects);
        context__.validate_dims("parameter initialization", "z_subj", "matrix_d", context__.to_vec(5,numSubjects));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> z_subj(5, numSubjects);
        size_t z_subj_j_2_max__ = numSubjects;
        size_t z_subj_j_1_max__ = 5;
        ...
        validate_non_negative_index("rho_subj", "5", 5);
        validate_non_negative_index("rho_subj", "5", 5);
        context__.validate_dims("parameter initialization", "rho_subj", "matrix_d", context__.to_vec(5,5));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> rho_subj(5, 5);
        size_t rho_subj_j_2_max__ = 5;
        size_t rho_subj_j_1_max__ = 5;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 23;
            local_scalar_t__ prevWinEffect;
            (void) prevWinEffect;  // dummy to suppress unused var warning
            if (jacobian__)
                prevWinEffect = in__.scalar_constrain(lp__);
            else
                prevWinEffect = in__.scalar_constrain();

            current_statement_begin__ = 24;
            local_scalar_t__ prevLoseEffect;
            (void) prevLoseEffect;  // dummy to suppress unused var warning
            if (jacobian__)
                prevLoseEffect = in__.scalar_constrain(lp__);
            else
                prevLoseEffect = in__.scalar_constrain();
            ...
            if (jacobian__)
                rho_sess = in__.cholesky_factor_corr_constrain(5, lp__);
            else
                rho_sess = in__.cholesky_factor_corr_constrain(5);
            ...
            if (jacobian__)
                rho_subj = in__.cholesky_factor_corr_constrain(5, lp__);
            else
                rho_subj = in__.cholesky_factor_corr_constrain(5);
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> b_sess(5, numSessions);
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> b_subj(5, numSubjects);
            ...
            for (int n = 1; n <= numTrials; ++n) {
                ...
                if (as_bool(logical_neq(get_base1(prevWin, n, "prevWin", 1), 0))) {

                    current_statement_begin__ = 60;
                    stan::math::assign(H, ((prevWinEffect + get_base1(b_sess, 4, get_base1(sessionID, n, "sessionID", 1), "b_sess", 1)) + get_base1(b_subj, 4, get_base1(subjectID, n, "subjectID", 1), "b_subj", 1)));
                } else {

                    current_statement_begin__ = 62;
                    stan::math::assign(H, ((prevLoseEffect + get_base1(b_sess, 5, get_base1(sessionID, n, "sessionID", 1), "b_sess", 1)) + get_base1(b_subj, 5, get_base1(subjectID, n, "subjectID", 1), "b_subj", 1)));
                }
                current_statement_begin__ = 65;
                stan::model::assign(log_pRpL, 
                            stan::model::cons_list(stan::model::index_uni(n), stan::model::nil_index_list()), 
                            (((B + (SL * pow(get_base1(contrastLeft, n, "contrastLeft", 1), sens_n_exp))) + (SR * pow(get_base1(contrastRight, n, "contrastRight", 1), sens_n_exp))) + H), 
            ...
            lp_accum__.add(normal_log<propto__>(prevWinEffect, 0, 2));
            current_statement_begin__ = 76;
            lp_accum__.add(normal_log<propto__>(prevLoseEffect, 0, 2));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("prevWinEffect");
        names__.push_back("prevLoseEffect");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "Hierarchical_Logistic_OutcomeHistory_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double prevWinEffect = in__.scalar_constrain();
        vars__.push_back(prevWinEffect);

        double prevLoseEffect = in__.scalar_constrain();
        vars__.push_back(prevLoseEffect);

        Eigen::Matrix<double, Eigen::Dynamic, 1> sd_sess = in__.vector_lb_constrain(0, 5);
        size_t sd_sess_j_1_max__ = 5;
        for (size_t j_1__ = 0; j_1__ < sd_sess_j_1_max__; ++j_1__) {
            vars__.push_back(sd_sess(j_1__));
        }

        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> z_sess = in__.matrix_constrain(5, numSessions);
        size_t z_sess_j_2_max__ = numSessions;
        size_t z_sess_j_1_max__ = 5;
        for (size_t j_2__ = 0; j_2__ < z_sess_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < z_sess_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> rho_sess = in__.cholesky_factor_corr_constrain(5);
        size_t rho_sess_j_2_max__ = 5;
        size_t rho_sess_j_1_max__ = 5;
        for (size_t j_2__ = 0; j_2__ < rho_sess_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < rho_sess_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> sd_subj = in__.vector_lb_constrain(0, 5);
        size_t sd_subj_j_1_max__ = 5;
        for (size_t j_1__ = 0; j_1__ < sd_subj_j_1_max__; ++j_1__) {
            vars__.push_back(sd_subj(j_1__));
        }

        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> z_subj = in__.matrix_constrain(5, numSubjects);
        size_t z_subj_j_2_max__ = numSubjects;
        size_t z_subj_j_1_max__ = 5;
        for (size_t j_2__ = 0; j_2__ < z_subj_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < z_subj_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> rho_subj = in__.cholesky_factor_corr_constrain(5);
        size_t rho_subj_j_2_max__ = 5;
        size_t rho_subj_j_1_max__ = 5;
        for (size_t j_2__ = 0; j_2__ < rho_subj_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < rho_subj_j_1_max__; ++j_1__) {
        ...
        try {
            ...
            validate_non_negative_index("b_sess", "5", 5);
            validate_non_negative_index("b_sess", "numSessions", numSessions);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> b_sess(5, numSessions);
            stan::math::initialize(b_sess, DUMMY_VAR__);
            stan::math::fill(b_sess, DUMMY_VAR__);
            ...
            validate_non_negative_index("b_subj", "5", 5);
            validate_non_negative_index("b_subj", "numSubjects", numSubjects);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> b_subj(5, numSubjects);
            stan::math::initialize(b_subj, DUMMY_VAR__);
            stan::math::fill(b_subj, DUMMY_VAR__);
            ...
            validate_non_negative_index("corr_sess", "5", 5);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> corr_sess(5, 5);
            ...
            validate_non_negative_index("corr_subj", "5", 5);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> corr_subj(5, 5);
            ...
            size_t corr_sess_j_2_max__ = 5;
            size_t corr_sess_j_1_max__ = 5;
            ...
            size_t corr_subj_j_2_max__ = 5;
            size_t corr_subj_j_1_max__ = 5;
    ...
    static std::string model_name() {
        return "Hierarchical_Logistic_OutcomeHistory_model";
    }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "prevWinEffect";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "prevLoseEffect";
        param_names__.push_back(param_name_stream__.str());
        size_t sd_sess_j_1_max__ = 5;
        for (size_t j_1__ = 0; j_1__ < sd_sess_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        size_t rho_sess_j_1_max__ = ((5 * (5 - 1)) / 2);
        for (size_t j_1__ = 0; j_1__ < rho_sess_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
        ...
        size_t rho_subj_j_1_max__ = ((5 * (5 - 1)) / 2);
        for (size_t j_1__ = 0; j_1__ < rho_subj_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
        ...
        if (!include_gqs__) return;
        size_t corr_sess_j_1_max__ = ((5 * (5 - 1)) / 2);
        for (size_t j_1__ = 0; j_1__ < corr_sess_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "corr_sess" << '.' << j_1__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        size_t corr_subj_j_1_max__ = ((5 * (5 - 1)) / 2);
        for (size_t j_1__ = 0; j_1__ < corr_subj_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef Hierarchical_Logistic_OutcomeHistory_model_namespace::Hierarchical_Logistic_OutcomeHistory_model stan_model;
